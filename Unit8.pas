...
procedure TForm8.IntensityColor;
var
...
procedure TForm8.TrackBarBlueChange(Sender: TObject);
begin
  IntensityColor;
end;

procedure TForm8.TrackBarGreenChange(Sender: TObject);
begin
  IntensityColor;
end;

procedure TForm8.TrackBarRedChange(Sender: TObject);
begin
  IntensityColor;
end;

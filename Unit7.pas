...
procedure TForm7.EditBrightChange(Sender: TObject);
begin
  buffer.Assign(img);
...
procedure TForm7.EditContrastChange(Sender: TObject);
begin
  buffer.Assign(img);
...
procedure TForm7.TrackBarBrightChange(Sender: TObject);
begin
  EditBright.Text:=IntToStr(TrackBarBright.Position);
end;

procedure TForm7.TrackBarContrastChange(Sender: TObject);
begin

...
procedure TForm13.ButtonCancelClick(Sender: TObject);
begin
  buffer.Assign(img);
  Form13.Close;
...
procedure TForm13.ButtonOkClick(Sender: TObject);
begin
  img.Assign(buffer);
  Form13.Close;
end;

procedure TForm13.EditBChange(Sender: TObject);
begin
...
procedure TForm13.EditGChange(Sender: TObject);
begin
  buffer.Assign(img);
...
procedure TForm13.EditRChange(Sender: TObject);
begin
  buffer.Assign(img);
...
procedure TForm13.TrackBarRChange(Sender: TObject);
begin
  EditR.Text:=IntToStr(TrackBarR.Position);
end;

procedure TForm13.TrackBarBChange(Sender: TObject);
begin
  EditB.Text:=IntToStr(TrackBarB.Position);
end;

procedure TForm13.TrackBarGChange(Sender: TObject);
begin
